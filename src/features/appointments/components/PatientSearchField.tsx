...
export function PatientSearchField({ value, patientName, onChange, onAddNew, isDisabled }: PatientSearchFieldProps) {
          ...
          {onAddNew && (
            <div className="border-t border-border p-2">
              <Button
                ...
                onPress={() => { setOpen(false); onAddNew(debouncedSearch); }}
              >
